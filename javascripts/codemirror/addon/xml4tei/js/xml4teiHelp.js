...
(function($) {
    $.fn.xml4teiHelp = function(options) {
        ...
        var driverSetup = function() {
            var setup = {};
console.log(settings.proxy + jsonsource);
        ...
        this.initialize = function() {
            ...
            $('body').append('<!--Help Panel-->' +
                '<div id="help_panel" class="panel panel-primary" role="document" style="display:none; position: fixed; top: 0; right: 0;  z-index: 10040; min-height:500px; width:600px;">' +
